...
import { STEVE_AVATAR_FALLBACK, STEVE_BODY_FALLBACK } from '../lib/constants.ts';
...
export default function ProfilePage() {
  ...
  return (
    <div className="flex-grow flex flex-col p-6 overflow-y-auto no-drag custom-scrollbar space-y-5 select-none bg-[#070b19]">
      {/* Header & Tabs */}
      <div className="flex justify-between items-center border-b border-white/[0.06] pb-4 shrink-0">
        ...
        {/* Navigation Tabs */}
        <div className="flex gap-1 bg-white/[0.03] border border-white/[0.04] p-0.5 rounded-xl">
          <button
      ...
      {activeTab === 'profile' ? (
        loadingProfile ? (
          ...
          <div className="grid grid-cols-12 gap-5 items-stretch animate-[fadeIn_0.25s_ease-out]">
            ...
            <div className="col-span-4 bg-[#0f172a]/70 border border-white/[0.06] rounded-2xl p-4 flex flex-col items-center justify-center">
              <div className="h-64 flex items-center justify-center relative py-4 select-none pointer-events-none">
                <img
                  src={`https://minotar.net/body/${session?.name || 'Steve'}/220`}
            ...
            <div className="col-span-8 space-y-4">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end gap-1.5">
                    <span className="text-[9px] font-extrabold bg-[#2D7DD2]/15 border border-[#2D7DD2]/20 text-[#2D7DD2] px-2.5 py-0.5 rounded-lg uppercase tracking-wider">
                      {session?.type === 'ms' ? t('home.accountPremium') : t('home.accountCracked')} {t('profile.accountLabel')}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-[#0f172a]/70 border border-white/[0.06] p-4 rounded-2xl flex items-center gap-3">
                ...
                <div className="bg-[#0f172a]/70 border border-white/[0.06] p-4 rounded-2xl flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <select
                      ...
                      className="bg-[#070b19] border border-white/[0.08] text-[10px] font-bold text-white rounded px-1 py-0.5 outline-none focus:border-[#2D7DD2] cursor-pointer"
                    >
              ...
              <div className="bg-[#0f172a]/70 border border-white/[0.06] rounded-2xl p-4 space-y-3">
        ...
        loadingAchievements ? (
          ...
          <div className="grid grid-cols-3 gap-4 animate-[fadeIn_0.25s_ease-out]">
            {achievements.map((a) => (
              <div 
                key={a.id} 
                className={`bg-[#0f172a]/70 border rounded-2xl p-5 flex flex-col justify-between transition-all duration-300 relative overflow-hidden ${
                  a.completed 
                    ? 'border-[#2D7DD2]/30 bg-gradient-to-br from-[#0f172a]/70 to-[#2D7DD2]/10 shadow-[0_0_15px_rgba(45,125,210,0.05)]' 
        ...
        loadingLeaderboard ? (
          ...
          <div className="bg-[#0f172a]/70 border border-white/[0.06] rounded-2xl p-5 overflow-hidden flex flex-col flex-grow animate-[fadeIn_0.25s_ease-out] max-h-[460px]">
            ...
            <div className="flex-grow overflow-y-auto custom-scrollbar pr-1">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="border-b border-white/[0.06] text-[9px] text-[#52525B] uppercase font-black tracking-widest">
